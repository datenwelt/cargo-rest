...
public class Xml {
    ...
    private static XmlMapper defaultObjectMapper;
    
    public static ObjectMapper getDefaultObjectMapper() {
        if (defaultObjectMapper == null) {
            defaultObjectMapper = new XmlMapper();
            defaultObjectMapper.configure(WRITE_XML_DECLARATION, true);
            defaultObjectMapper.configure(WRITE_XML_1_1, true);
