 ...
 * @author job
 */
public class ApplicationYaml implements ContentType {
    ...
    public Optional<ContentProducer> producerFor(AcceptHeader acceptedMediaTypes, AcceptHeader acceptedCharsets, Request request, Response response) {
        ...
        if (!acceptedMediaTypes.accepts("application/x-yaml") || !acceptedCharsets.accepts("utf-8")) {
            return null;
        }
        return Optional.of(new YamlProducer());
    }
